...
class GoalInvert extends Goal {
  ...
  heuristic (node) {
    // A* requires non-negative heuristics; for an inverted goal we use 0
    // as a safe admissible heuristic since there is no well-defined
    // "distance to not being at a point"
    return 0
  }
